@echo on
echo === VetCare 360 - Final Application ===
...
echo Compiling VetCare360Final.java...
...
echo Running VetCare 360 Final...
java --module-path "%CD%\javafx-sdk-21.0.7\lib" --add-modules javafx.controls,javafx.graphics,javafx.base -cp ".;%CD%\lib\mysql-connector-java-8.0.28.jar" VetCare360Final
